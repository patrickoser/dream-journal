...
Return ONLY the interpretation text, no preamble.`;
...
Tone: present tense, empowering, poetic but accessible.
Example: "Today I move with the fluid grace I felt in my dream. I trust that something is shifting beneath the surface..."
Return ONLY the manifestation text, no preamble.`;
